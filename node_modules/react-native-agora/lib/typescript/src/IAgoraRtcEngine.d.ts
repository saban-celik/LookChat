...
export interface IRtcEngineEventHandler {
     ...
     * @param layoutlist Layout information of a specific sub-video stream within the mixed stream. See VideoLayout.
     */
...
export declare abstract class IRtcEngine {
     ...
     *  < 0: Failure.
     */
    abstract setFilterEffectOptions(enabled: boolean, options: FilterEffectOptions, type?: MediaSourceType): number;
    /**
     ...
     *  < 0: Failure.
     */
    abstract setLocalRenderTargetFps(sourceType: VideoSourceType, targetFps: number): number;
    /**
     ...
     *
     * @param config The camera capture configuration. See CameraCapturerConfiguration. In this method, you do not need to set the deviceId parameter.
     *
     * @returns
     * 0: Success.
     *  < 0: Failure.
     ...
     *
     * @param speakerOn Sets whether to enable the speakerphone or earpiece: true : Enable device state monitoring. The audio route is the speakerphone. false : Disable device state monitoring. The audio route is the earpiece.
     *
     * @returns
     * 0: Success.
     *  < 0: Failure.
     ...
     * @ignore
     */
    abstract startScreenCaptureByWindowId(windowId: number, regionRect: Rectangle, captureParams: ScreenCaptureParameters): number;
    /**
     ...
     *  -7: The IRtcEngine object has not been initialized. You need to initialize the IRtcEngine object before calling this method.
     */
    abstract updateLocalAudioMixerConfiguration(config: LocalAudioMixerConfiguration): number;
    /**
...
//# sourceMappingURL=IAgoraRtcEngine.d.ts.map